...
GOBUILD=CGO_ENABLED=0 go build -trimpath -gcflags="all=-N -l" -ldflags '-X "github.com/designinlife/jetbrains/common.Version=$(VERSION)" \
		-X "github.com/designinlife/jetbrains/common.BuiltOn=$(BUILDTIME)" \
		-w -s -extldflags="static" -buildid='
